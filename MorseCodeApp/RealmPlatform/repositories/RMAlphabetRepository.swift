...
struct RMAlphabetRepository: AlphabetRepositoryProtocol {
    ...
    func getAll() -> Observable<[Alphabet]> {
     ...
     func reset() {
        ...
        let engilshPairs = [Pair(id: 301, key: "A", value: "•—", isVisible: true, color: UIColor(hexString: "#FAC7FF")!),
                            Pair(id: 302, key: "B", value: "—•••", isVisible: true, color: UIColor(hexString: "#FFCF94")!),
                            Pair(id: 303, key: "C", value: "—•—•", isVisible: true, color: UIColor(hexString: "#FFEBC2")!),
                            Pair(id: 305, key: "D", value: "—••", isVisible: true, color: UIColor(hexString: "#B3DBFF")!),
                            Pair(id: 306, key: "E", value: "•", isVisible: true, color: UIColor(hexString: "#CF99FF")!),
                            Pair(id: 308, key: "F", value: "••—•", isVisible: true, color: UIColor(hexString: "#FFA199")!),
                            Pair(id: 309, key: "G", value: "——•", isVisible: true, color: UIColor(hexString: "#FDFFCC")!),
                            Pair(id: 310, key: "H", value: "••••", isVisible: true, color: UIColor(hexString: "#85F2FF")!),
                            Pair(id: 311, key: "I", value: "••", isVisible: true, color: UIColor(hexString: "#B7FFA3")!),
                            Pair(id: 312, key: "J", value: "•———", isVisible: true, color: UIColor(hexString: "#9ECAFF")!),
                            Pair(id: 313, key: "K", value: "—•—", isVisible: true, color: UIColor(hexString: "#F3FF8A")!),
                            Pair(id: 314, key: "L", value: "•—••", isVisible: true, color: UIColor(hexString: "#B280FF")!),
                            Pair(id: 316, key: "M", value: "——", isVisible: true, color: UIColor(hexString: "#8FADFF")!),
                            Pair(id: 317, key: "N", value: "—•", isVisible: true, color: UIColor(hexString: "#C7E7FF")!),
                            Pair(id: 319, key: "O", value: "———", isVisible: true, color: UIColor(hexString: "#FFCEB3")!),
                            Pair(id: 321, key: "P", value: "•——•", isVisible: true, color: UIColor(hexString: "#E5C7FF")!),
                            Pair(id: 322, key: "Q", value: "——•—", isVisible: true, color: UIColor(hexString: "#FFDB99")!),
                            Pair(id: 323, key: "R", value: "•—•", isVisible: true, color: UIColor(hexString: "#A7FF8F")!),
                            Pair(id: 324, key: "S", value: "•••", isVisible: true, color: UIColor(hexString: "#FFD994")!),
                            Pair(id: 326, key: "T", value: "—", isVisible: true, color: UIColor(hexString: "#97FF8F")!),
                            Pair(id: 327, key: "U", value: "••—", isVisible: true, color: UIColor(hexString: "#B8F0FF")!),
                            Pair(id: 328, key: "V", value: "•••—", isVisible: true, color: UIColor(hexString: "#CE80FF")!),
                            Pair(id: 329, key: "W", value: "•——", isVisible: true, color: UIColor(hexString: "#FFA39E")!),
                            Pair(id: 330, key: "X", value: "—••—", isVisible: true, color: UIColor(hexString: "#A3C2FF")!),
                            Pair(id: 331, key: "Y", value: "—•——", isVisible: true, color: UIColor(hexString: "#FFAEFA")!),
                            Pair(id: 332, key: "Z", value: "——••", isVisible: true, color: UIColor(hexString: "#E480FF")!),
                            Pair(id: 335, key: "0", value: "—————", isVisible: true, color: UIColor(hexString: "#BDFFB8")!),
                            Pair(id: 336, key: "1", value: "•————", isVisible: true, color: UIColor(hexString: "#A3C0FF")!),
                            Pair(id: 337, key: "2", value: "••———", isVisible: true, color: UIColor(hexString: "#E1FF80")!),
                            Pair(id: 338, key: "3", value: "•••——", isVisible: true, color: UIColor(hexString: "#E4FFA3")!),
                            Pair(id: 339, key: "4", value: "••••—", isVisible: true, color: UIColor(hexString: "#FFE0B8")!),
                            Pair(id: 340, key: "5", value: "•••••", isVisible: true, color: UIColor(hexString: "#D1FFAE")!),
                            Pair(id: 341, key: "6", value: "—••••", isVisible: true, color: UIColor(hexString: "#FFC2FD")!),
                            Pair(id: 342, key: "7", value: "——•••", isVisible: true, color: UIColor(hexString: "#8097FF")!),
                            Pair(id: 343, key: "8", value: "———••", isVisible: true, color: UIColor(hexString: "#E3BDFF")!),
                            Pair(id: 344, key: "9", value: "————•", isVisible: true, color: UIColor(hexString: "#AEFFB4")!),
                            Pair(id: 345, key: ".", value: "•—•—•—", isVisible: true, color: UIColor(hexString: "#AEAFFF")!),
                            Pair(id: 346, key: ",", value: "——••——", isVisible: true, color: UIColor(hexString: "#FFFFC7")!),
                            Pair(id: 347, key: "'", value: "•————•", isVisible: true, color: UIColor(hexString: "#F6FFC2")!),
                            Pair(id: 348, key: "\"", value: "•—••—•", isVisible: true, color: UIColor(hexString: "#B7AEFF")!),
                            Pair(id: 349, key: "_", value: "••——•—", isVisible: true, color: UIColor(hexString: "#A8FF85")!),
                            Pair(id: 350, key: ":", value: "———•••", isVisible: true, color: UIColor(hexString: "#FFE880")!),
                            Pair(id: 351, key: ";", value: "—•—•—•", isVisible: true, color: UIColor(hexString: "#FFAEBD")!),
                            Pair(id: 352, key: "?", value: "••——••", isVisible: true, color: UIColor(hexString: "#FFCCE8")!),
                            Pair(id: 353, key: "!", value: "—•—•——", isVisible: true, color: UIColor(hexString: "#DEC2FF")!),
                            Pair(id: 354, key: "-", value: "—••••—", isVisible: true, color: UIColor(hexString: "#AEDDFF")!),
                            Pair(id: 355, key: "+", value: "•—•—•", isVisible: true, color: UIColor(hexString: "#FF80D9")!),
                            Pair(id: 356, key: "/", value: "—••—•", isVisible: true, color: UIColor(hexString: "#FFC3C2")!),
                            Pair(id: 357, key: "(", value: "—•——•", isVisible: true, color: UIColor(hexString: "#FFFE85")!),
                            Pair(id: 358, key: ")", value: "—•——•—", isVisible: true, color: UIColor(hexString: "#AEFFD4")!),
                            Pair(id: 359, key: "=", value: "—•••—", isVisible: true, color: UIColor(hexString: "#99FFC8")!),
                            Pair(id: 360, key: "@", value: "•——•—•", isVisible: true, color: UIColor(hexString:"#85E7FF")!),
                            Pair(id: 370, key: " ", value: " ", isVisible: false, color: UIColor(hexString: "#FFFFFF")!)
        ]
