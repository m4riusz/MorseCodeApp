...
//                self.createAlphabets() // TEMPRORARY
    ...
    func getAll() -> Observable<[Alphabet]> {
     ...
     func createAlphabets() {
        let polishPairs: [Pair] = [Pair(id: 100, key: "A", value: "•—", isVisible: true, color: UIColor(hexString: "#FAC7FF")!),
     ...
     let polishAlphabet = Alphabet(id: 1, countryCode: "PL", name: "Polski", pairs: polishPairs, isSelected: false)
        ...
        let engilshPairs: [Pair] = [Pair(id: 101, key: "A", value: "•—", isVisible: true, color: UIColor(hexString: "#FAC7FF")!),
